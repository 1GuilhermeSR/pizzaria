...
function Pedidos({ listaPedidos, status, dataIni, dataFin }) {
    ...
    const [pedidosPendentesFiltrados, setPedidosPendentesFiltrados] = useState(pedidosPendentes);
    const [pedidosProducaoFiltrados, setPedidosProducaoFiltrados] = useState(pedidosProducao);
    const [pedidosEntregaFiltrados, setPedidosEntregaFiltrados] = useState(pedidosEntrega);
